...
$cc -I$ffmpeg_src -c -o scale.o scale.c
...
$cc -shared pypopro.o encoder.o decoder.o scale.o overlay.o ivf.o $ll -L/opt/local/Library/Frameworks/Python.framework/Versions/3.4/lib/ -lpython3.4 -o pypopro.so
